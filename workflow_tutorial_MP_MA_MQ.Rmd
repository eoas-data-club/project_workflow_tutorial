...
### Step 4: Plot the relationship between other potential explanatory variables (weather, barometric pressure, water temperature, air temperature, time of day, etc.) and catchrate.
...
plot(catchrates$barometric_pressure_mmHg,catchrates$catchrate)
...
cor(catchrates[,7:16])
g<-ggplot(catchrates[,7:16], aes(x=catchrate)) +
  geom_tile()

...
1. Clone the "project_workflow_tutorial" repository to your computer
2. Pull the latest version of the repository from Github (good practice for later)
3. Open the .Rproj file, then open the "project_workflow_tutorial.Rmd" script
4. Save the RMarkdown script as a new file, adding your initials or a team name. This will allow us to work on the same script in the same repository without creating commit conflicts, so it's important!
5. Check that you have all the packages we're going to be using installed in your version of R or RStudio.

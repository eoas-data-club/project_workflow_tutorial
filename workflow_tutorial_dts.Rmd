...
plot(fitdist(catch$catchrate, 'nbinom'))
...
plot(catch$catchrate ~ catch$turbidity_fnu)
...
par(mfrow = c(2,2))
plot(catch$catchrate ~ catch$turbidity_fnu)
plot(catch$catchrate ~ catch$water_temp_c)
plot(catch$catchrate ~ catch$total_dissolved_solids_mg.l)
plot(catch$catchrate ~ catch$conductivity_muS.cm)
